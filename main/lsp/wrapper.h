...
protected:
    ...
    LSPWrapper(std::unique_ptr<core::GlobalState> gs, std::shared_ptr<options::Options> opts,
               ...
               std::shared_ptr<spd::logger> typeErrorsConsole, std::unique_ptr<ReadOnlyKeyValueStore> kvstore,
...
class SingleThreadedLSPWrapper final : public LSPWrapper {
    ...
    SingleThreadedLSPWrapper(std::unique_ptr<core::GlobalState> gs, std::shared_ptr<options::Options> opts,
                             ...
                             std::unique_ptr<ReadOnlyKeyValueStore> kvstore, bool disableFastPath);
...
public:
    ...
    createWithGlobalState(std::unique_ptr<core::GlobalState> gs, std::shared_ptr<options::Options> options,
                          std::shared_ptr<spdlog::logger> logger, std::unique_ptr<ReadOnlyKeyValueStore> kvstore,
